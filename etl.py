...
clean_df = clean_df.rename(columns={"Preço de mercado": "Preço"})
clean_df[['Album', 'Título', 'Gênero', 'Ano', 'Selo']] = clean_df[['Album', 'Título', 'Gênero', 'Ano', 'Selo']].fillna("Não Informado")
